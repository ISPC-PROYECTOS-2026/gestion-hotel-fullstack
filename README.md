# Aires de las Sierras - Sistema web de Gestion Hotelera
...
### Administrador
- Gestion de recepcionistas y usuarios del sistema
...
git clone https://github.com/ISPC-PROYECTOS-2026/gestion-hotel-fullstack.git

2. Ingresar a la carpeta de la maqueta:

cd gestion-hotel-fullstack

3. Abrir el archivo **index.html** en el navegador web
